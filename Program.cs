...
options.UseSqlServer(builder.Configuration.GetConnectionString("Ardelean_Daria_Labb2Context")
 ?? throw new InvalidOperationException("Connection string 'Ardelean_Daria_Labb2Context' not found.")));
